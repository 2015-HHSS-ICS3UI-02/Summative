...
public class FinalProject extends JComponent implements KeyListener {
    ...
    int speed = 1;
    //boolean 2D array
    boolean[][][] T = new boolean[3][3][4];
    boolean[][][] I = new boolean[4][4][4];
    boolean[][][] Z = new boolean[3][3][4];
    boolean[][][] S = new boolean[3][3][4];
    boolean[][][] L = new boolean[3][3][4];
    boolean[][][] J = new boolean[3][3][4];
    boolean[][][] O = new boolean[3][3][4];
    int x = 165;
    int y = 75;
    int w = 30;
    int h = 30;
        ...
        if (randnum == 1) {
            ...
            for (int row = 0; row < T.length; row++) {
                for (int col = 0; col < T[0].length; col++) {
                    if (T[row][col][r]) {
                        g.fillRect(x + w * col, y + h * row, w, h);
                    }
                }
            }
        } else if (randnum == 2) {
